...
export function Sidebar({ isOpen, onSelectSession, currentSessionId, onNewChat, onUploadSuccess, needsRefresh }: SidebarProps) {
            ...
            <div className="p-4 flex-1 overflow-y-auto">
              ...
              <div>
                ...
                <div className="space-y-1">
                   ...
                   {sessions.length === 0 && (
                       <div className="px-3 py-2 text-xs text-gray-400 italic">No previous chats</div>
                   )}
                </div>
              </div>
            </div>
